...
# * To get more understanding regarding the dataset, please go to the `data_directory` folder in this repository.
...
# 
# **Process Overview:**
# * **Identify the Source for Descriptive Names:** The descriptive names corresponding to these short labels are typically documented in the codebook in HTML (see the `data_directory` folder) or metadata provided by the data collection authority. In this case, the descriptive names are found in an HTML document provided by the BRFSS.
